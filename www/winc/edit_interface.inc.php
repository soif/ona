    ...
    $window['html'] .= <<<EOL
        ...
        <tr>
            ...
            <td class="padding" align="left" width="100%" nowrap="true">
                ...
                &nbsp;<span id="iptomac_{$window_name}" title="Set MAC Address from IP" onClick="xajax_iptomac(document.getElementById('set_ip_{$window_name}').value,'set_mac')"><img src="{$images}/silk/arrow_down.png" border="0"/></span>
